...
const UpdateBookForm = ({ book, onSubmit }) => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center text-gray-800 rounded-xl min-h-screen caret-transparent">
      <form
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 w-full rounded-lg grow">
              <div className="px-5 py-3 border-4 border-dotted border-gray-300 rounded-lg text-center">
                <label className="cursor-pointer text-gray-600 dark:text-white font-medium">
            ...
            <button
              type="submit"
              className="border-0 w-full p-3 mt-5 text-white rounded-md btn btn-primary bg-purple-500 dark:bg-amber-500"
            >
              Update Book
            </button>
          </div>

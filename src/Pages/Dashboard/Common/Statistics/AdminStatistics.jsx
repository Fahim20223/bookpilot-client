      ...
      <div className="mt-6 sm:mt-12">
        ...
        <div className="mb-8 sm:mb-12 grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="relative flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/50 transition-all duration-300 hover:shadow-xl dark:hover:shadow-gray-900/70">
            <div className="bg-gradient-to-tr from-orange-600 to-orange-400 mx-4 rounded-xl shadow-lg absolute -mt-4 grid h-14 w-14 sm:h-16 sm:w-16 place-items-center text-white shadow-orange-500/40">
          ...
          {/* Total Orders Card */}
          <div className="relative flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/50 transition-all duration-300 hover:shadow-xl dark:hover:shadow-gray-900/70">
            <div className="bg-gradient-to-tr from-blue-600 to-blue-400 mx-4 rounded-xl shadow-lg absolute -mt-4 grid h-14 w-14 sm:h-16 sm:w-16 place-items-center text-white shadow-blue-500/40">
          ...
          {/* Total Books Card */}
          <div className="relative flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/50 transition-all duration-300 hover:shadow-xl dark:hover:shadow-gray-900/70">
            <div className="bg-gradient-to-tr from-pink-600 to-pink-400 mx-4 rounded-xl shadow-lg absolute -mt-4 grid h-14 w-14 sm:h-16 sm:w-16 place-items-center text-white shadow-pink-500/40">
          ...
          {/* Total Users Card */}
          <div className="relative flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/50 transition-all duration-300 hover:shadow-xl dark:hover:shadow-gray-900/70">
            <div className="bg-gradient-to-tr from-green-600 to-green-400 mx-4 rounded-xl shadow-lg absolute -mt-4 grid h-14 w-14 sm:h-16 sm:w-16 place-items-center text-white shadow-green-500/40">

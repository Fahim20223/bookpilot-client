...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`z-10 md:fixed flex flex-col justify-between overflow-x-hidden bg-white dark:bg-black border-r border-gray-200 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform ${
